 ...
 * enough to cover the async TEE callback. Without enough balance + lock
 * duration, judgeAll reverts (e.g. "insufficient lock duration").
 *
 * Fixed protocol contract — address is hard-coded.
 */
